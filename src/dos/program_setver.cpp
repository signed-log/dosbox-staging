...
void SETVER::AddMessages()
{
	MSG_Add("PROGRAM_SETVER_HELP_LONG",
	        ...
	        "\n"
	        "Where:\n"
	        "  [color=light-cyan]FILE[reset]     is a file (optionally with path) to apply the settings to.\n"
	        "  [color=light-cyan]VERSION[reset]  is a DOS version, in [color=white]n[reset].[color=white]nn[reset], [color=white]n[reset].[color=white]n[reset] or [color=white]n[reset] format.\n"
