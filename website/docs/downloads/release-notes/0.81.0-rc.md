...
Here are the shaders in action at 4K resolution (make sure click on the
...
<figure markdown>
  <a class="glightbox" href="../images/ultima-underworld.jpg" >
    ![Ultima Underworld: The Stygian Abyss -- 320&times;200 VGA](images/ultima-underworld-small.jpg){ loading=lazy .skip-lightbox }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/celtic-tales.jpg" >
    ![Celtic Tales: Balor of the Evil Eye -- 640&times;480 VGA](images/celtic-tales-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/dark-seed.jpg" >
    ![Dark Seed --640&times;350 EGA](images/dark-seed-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/monkey-island.jpg" >
    ![The Secret of Monkey Island -- 320&times;200 EGA](images/monkey-island-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/space-quest-iii.jpg" >
    ![Space Quest III: The Pirates of Pestulon -- 320&times;200 EGA](images/space-quest-iii-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/wizardry.jpg" >
    ![Wizardy: Proving Grounds of the Mad Overlord -- 320&times;200 CGA](images/wizardry-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/smoker.jpg" >
    ![Smoker by Fairfax --320&times;200 15kHz "arcade" shader](images/smoker-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/zak.jpg" >
    ![Zak McKracken and the Alien Mindbenders -- 320&times;200 CGA composite](images/zak-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  <a class="glightbox" href="../images/starblade.jpg" >
    ![Starblade -- 720&times;348 Hercules](images/starblade-small.jpg){ loading=lazy }
  </a>
...
<figure markdown>
  ![Price of Persia (default)](images/pop-hercules.png){ loading=lazy }
...
<figure markdown>
  ![Price of Persia (aspect ratio corrected )](images/pop-hercules-aspect-corrected.png){ loading=lazy }
...
<figure markdown>
  ![Angel Devoid: Face of the Enemy --- raw output](images/angel-devoid-fixvideo.png){ loading=lazy }
...
<figure markdown>
  ![Gods -- 320&times;200 VGA](images/angel-devoid-fixvideo-scanline.png){ loading=lazy }
...
<figure markdown>
  ![Output of the improved MIXER /LISTMIDI command](images/mixer-listmidi.png){ loading=lazy }
...
<figure markdown>
  ![New run with log window macOS shortcut](images/macos-logging-shortcut.png){ width=85% loading=lazy }
</figure>
...
- The _Intel Floating Point Conformance Test for IEEE 754-1985_ passes with
  zero failures on x86 host CPUs with `core = normal` too now. 80-bit extended
  precision floating point numbers are truncated to 64-bit double precision on
  non-x86 hosts due to performance reasons; it's not recommended to use DOSBox
  Staging on such hosts for any engineering or financial calculations.
