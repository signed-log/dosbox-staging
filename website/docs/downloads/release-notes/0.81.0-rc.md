...
<figure markdown>
  ![Gods -- 320&times;200 VGA](images/gods.png){ loading=lazy }
...
<figure markdown>
  ![Ultima Underworld: The Stygian Abyss -- 320&times;200 VGA](images/ultima-underworld.png){ loading=lazy }
...
<figure markdown>
  ![Celtic Tales: Balor of the Evil Eye -- 640&times;480 VGA](images/celtic-tales.png){ loading=lazy }
...
<figure markdown>
  ![Dark Seed --640&times;350 EGA](images/dark-seed.png){ loading=lazy }
...
<figure markdown>
  ![The Secret of Monkey Island -- 320&times;200 EGA](images/monkey-island.png){ loading=lazy }
...
<figure markdown>
  ![Space Quest III: The Pirates of Pestulon -- 320&times;200 EGA](images/space-quest-iii.png){ loading=lazy }
...
<figure markdown>
  ![Wizardy: Proving Grounds of the Mad Overlord -- 320&times;200 CGA](images/wizardry.png){ loading=lazy }
...
<figure markdown>
  ![Smoker by Fairfax --320&times;200 15kHz "arcade" shader](images/smoker.png){ loading=lazy }
...
<figure markdown>
  ![Zak McKracken and the Alien Mindbenders -- 320&times;200 CGA composite](images/zak.png){ loading=lazy }
...
<figure markdown>
  ![Starblade -- 720&times;348 Hercules](images/starblade.png){ loading=lazy }
